        ...
        try {
            ...
            switch (accion) {
                ...
                case "insert":
                    ...
                    result2 = " ";
                    try {
                        String QuerySelect = "SELECT idPersona " +
                                "FROM sozsu9g190okokyf.personas where tipo = 'contacto' and email='" + persona.getEmail() + "'";
                        ...
                        if (rs2.isBeforeFirst()) {
                            ...
                            st.executeUpdate("DELETE FROM sozsu9g190okokyf.alarmas where idPersona=" + persona.getIdPersona());
                            st.executeUpdate("DELETE FROM sozsu9g190okokyf.personas where idPersona=" + persona.getIdPersona());
                        }
